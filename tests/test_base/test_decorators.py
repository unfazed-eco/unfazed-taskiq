...
class TestRegistryTaskParam:
    ...
    def test_registry_task_param_creation(self):
...
class TestRegistryService:
    ...
    def test_register_duplicate_task_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Task test.module.task already registered"):
            self.registry.register("test.module.task", task2)

    def test_filter_path(self):
        """Test filter_path functionality."""
        task1 = RegistryTask(name="math_task", broker_name="math", params=[], docs=None, schedule=None)
        task2 = RegistryTask(name="string_task", broker_name="string", params=[], docs=None, schedule=None)
...
class TestTaskDecorator:
    ...
    def test_task_decorator_basic_functionality(self):
    ...
    def test_task_decorator_with_parameters_and_schedule(self):
        ...
        with patch('unfazed_taskiq.decorators.get_agent') as mock_get_agent:
            with patch('unfazed_taskiq.decorators.rs') as mock_rs:
                ...
                async def parameterized_task(x: int, y: str = "default", z: Optional[bool] = None):
    ...
    def test_global_registry_service(self):
