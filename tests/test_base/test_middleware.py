...
class TestUnfazedTaskiqExceptionMiddleware:
    ...
    async def test_on_error_calls_capture_exception(self):
    ...
    @pytest.mark.asyncio
    async def test_on_error_logs_error_with_correct_format(self):
        ...
        with patch('unfazed_taskiq.middleware.capture_exception'):
            with patch('unfazed_taskiq.middleware.logger') as mock_logger:
                ...
                assert extra_data['exception_type'] == type(self.test_exception).__name__
